...
<section className="w-11/12 m-auto">
      <div>
        <h1 className="text-3xl font-light text-gray-100 my-3">Recommended</h1>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 md:gap-y-10 gap-x-6 mt-6">
